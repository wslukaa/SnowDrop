...
def main():
	...
	try:
		...
		iid = "insert into citiesweather (\
			...
			spd, \
			cond_code, \
			cond_txt, pm10, sqi, fl, vis, sport_sug, sport_txt) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
		...
		#	print content
			...
			values.append(rd['aqi']['city']['pm10'])
			values.append(rd['aqi']['city']['aqi'])
			values.append(rd['now']['fl'])
			values.append(rd['now']['vis'])
			values.append(rd['suggestion']['sport']['brf'])
			values.append(rd['suggestion']['sport']['txt'])
