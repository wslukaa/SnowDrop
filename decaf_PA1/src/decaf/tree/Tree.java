...
public abstract class Tree {
    ...
    public static final int GUARDEDIF = NUMINSTANCES + 1;
    ...
    public static class GuardedIf extends Tree {
		...
		public GuardedIf(List<Tree> stmts, List<Expr> exprs, Location loc) {
			super(GUARDEDIF, loc);
			this.stmts = stmts;
			this.exprs = exprs;
		...
		public void printTo(IndentPrintWriter pw) {
			...
			for (int i = 0; i < stmts.size(); i++) {
    			...
    			pw.incIndent();
    			exprs.get(i).printTo(pw);
    			stmts.get(i).printTo(pw);
    			pw.decIndent();
			}
			pw.decIndent();
		}
    ...
    public static class GuardedDo extends Tree {
		...
		public GuardedDo(List<Tree> stmts, List<Expr> exprs, Location loc) {
			super(GUARDEDDO, loc);
			this.stmts = stmts;
			this.exprs = exprs;
			// TODO Auto-generated constructor stub
   ...
   public static class Ternary extends Expr {
	    ...
	    public Expr expr_1, expr_2, expr_3;
	    
		public Ternary(int kind, Expr expr_1, Expr expr_2, Expr expr_3, Location loc_1, Location loc_2) {
			super(kind, loc_1);
    		this.expr_1 = expr_1;
    		this.expr_2 = expr_2;
    		this.expr_3 = expr_3;   		
    ...
    public static class Numinstances extends Expr {
		...
		public Numinstances(String s, Location loc) {
